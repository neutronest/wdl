...
from wdl.official.utils.logs import hooks_helper
from wdl.official.utils.logs import logger
from wdl.official.utils.misc import model_helpers
...
def run_loop(name, train_input_fn, eval_input_fn, model_column_fn,
  ...
  with tf.contrib.tfprof.ProfileContext('/tmp/census_training_profile') as pctx:
